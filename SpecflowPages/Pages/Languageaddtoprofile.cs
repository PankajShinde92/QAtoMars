...
public class LanguagePageTest {
  ...
  public void languagePage() {
    ...
    // 12 | type | name=name | ASDF
    driver.FindElement(By.Name("name")).SendKeys("ASDF");
    // 13 | click | name=level | 
    driver.FindElement(By.Name("level")).Click();
    // 14 | select | name=level | label=Fluent
    {
      var dropdown = driver.FindElement(By.Name("level"));
      dropdown.FindElement(By.XPath("//option[. = 'Fluent']")).Click();
    }
    // 15 | click | name=level | 
    driver.FindElement(By.Name("level")).Click();
    // 16 | click | css=.six > .teal | 
    driver.FindElement(By.CssSelector(".six > .teal")).Click();
    // 17 | click | css=.ui:nth-child(2) > .row .ui .ui | 
    driver.FindElement(By.CssSelector(".ui:nth-child(2) > .row .ui .ui")).Click();
    // 18 | click | name=name | 
    driver.FindElement(By.Name("name")).Click();
    // 19 | type | name=name | SDER
    driver.FindElement(By.Name("name")).SendKeys("SDER");
    // 20 | click | name=level | 
    driver.FindElement(By.Name("level")).Click();
    // 21 | select | name=level | label=Native/Bilingual
    {
      var dropdown = driver.FindElement(By.Name("level"));
